...
import logoSvg from './source/transparent_logo_04.svg'

/**
 * Logo Transparent - Gjensidige
 ...
 */
const LogoTransparentGjensidige = (props) => {
    return (
        <ResponsiveLogo
            src={logoSvg}
            alt="Gjensidige Logo"
...
export default LogoTransparentGjensidige
