...
import BtnVariant03 from "../Button/BTN_variant03";
...
export default function TableAppointment() {
    ...
    return (
        ...
        <div>
            <p className={"textcontent--small--item1"}>{ t("sections:section_contacts_part02") }</p>
            {/*   <BtnVariant03 />*/}
        </div>
                ...
                <div className={"thisLink"}>
                    <a href={ Link01 } target="_blank" rel="noopener noreferrer">
                        <p className={"textcontent--small--item1"}>{ t("common:eapointment") }</p>
                    </a>
                </div>
            </div>
